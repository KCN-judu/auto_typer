...
inline CanCommandPlan defaultCanCommandPlan() {
  return {MotorDirection::Cw, 300, 10, 3200};
}
...
inline CanTestResult summarizeCanTest(bool controllerReady,
                                      ...
                                      bool zeroCommandSent,
                                      bool absoluteCommandSent,
                                      bool returnCommandSent,
                                      bool requestSent,
                                      bool stopSent,
                                      const CanRxState& feedback) {
  const bool transportOk =
      controllerReady && modeCommandSent && enableCommandSent && zeroCommandSent && absoluteCommandSent &&
      returnCommandSent && requestSent && stopSent;
